...
public class Analyzer extends Application {
    ...
    private void analyzeAndDisplay(File file, Label resultsLabel) throws IOException {
        ...
        try {
            ...
            resultsLabel.setText("Ошибка: Неподдерживаемая версия class-файла. Убедитесь, \n что используете совместимую версию Java и ASM.");
        } catch (IOException e) {
            resultsLabel.setText("Ошибка ввода-вывода: " + e.getMessage());
        }
